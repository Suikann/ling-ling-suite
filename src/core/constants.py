...
TEMPLATE_VARIABLES: List[TemplateVariable] = [
    TemplateVariable("序號", "逐檔不同", "樂器在樂器表中的位置，自動產生，零填充"),
    TemplateVariable("樂器", "逐檔不同", "樂器表，依排序對應"),
    TemplateVariable("曲名", "群組層級", "從檔名共同部分自動偵測，使用者可覆寫"),
    TemplateVariable("樂章編號", "群組層級", "使用者輸入"),
    TemplateVariable("樂章名稱", "群組層級", "使用者輸入"),
]
