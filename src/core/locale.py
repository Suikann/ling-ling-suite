...
_STRINGS: Dict[str, Dict[str, str]] = {
    "zh_TW": {
        ...
        "catalog.settings.spreadsheet_id": "譜庫試算表：",
        "catalog.settings.spreadsheet_hint": "貼上試算表網址或 ID",
        "catalog.settings.root_folder": "譜庫根目錄：",
        "catalog.settings.folder_hint": "貼上 Drive 資料夾網址或 ID",
        "catalog.settings.browse": "瀏覽...",
        "catalog.settings.pick_spreadsheet": "選取試算表",
        "catalog.settings.pick_folder": "選取資料夾",
        "catalog.settings.no_spreadsheets": "在你的 Drive 中找不到試算表。",
        "catalog.settings.no_folders": "在你的 Drive 中找不到資料夾。",
        "catalog.settings.create_new": "建立新譜庫",
        "catalog.settings.created": "已建立新譜庫試算表",
    ...
    "en": {
        ...
        "catalog.settings.spreadsheet_id": "Catalog Spreadsheet:",
        "catalog.settings.spreadsheet_hint": "Paste spreadsheet URL or ID",
        "catalog.settings.root_folder": "Library Root Folder:",
        "catalog.settings.folder_hint": "Paste Drive folder URL or ID",
        "catalog.settings.browse": "Browse...",
        "catalog.settings.pick_spreadsheet": "Select Spreadsheet",
        "catalog.settings.pick_folder": "Select Folder",
        "catalog.settings.no_spreadsheets": "No spreadsheets found in your Drive.",
        "catalog.settings.no_folders": "No folders found in your Drive.",
        "catalog.settings.create_new": "Create New Catalog",
        "catalog.settings.created": "New catalog spreadsheet created",
