...
_STRINGS: Dict[str, Dict[str, str]] = {
    "zh_TW": {
        ...
        "catalog.drive.collect_desc": "從 Drive 其他資料夾選取檔案，移動到這個資料夾中。適合將散落各處的分譜整合到同一個位置。",
        "catalog.drive.no_parts_yet": "此資料夾內沒有 PDF 檔案。",
        "catalog.drive.collect_hint": "展開資料夾找到要移入的檔案，勾選後按確定。",
    ...
    "en": {
        ...
        "catalog.drive.collect_desc": "Select files from other Drive folders and move them into this folder. Useful for consolidating scattered parts.",
        "catalog.drive.no_parts_yet": "No PDF files in this folder.",
        "catalog.drive.collect_hint": "Expand folders to find the files you want, check them, then click OK.",
