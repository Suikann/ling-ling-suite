...
_STRINGS: Dict[str, Dict[str, str]] = {
    "zh_TW": {
        ...
        "split.cancel": "取消",
        "split.execute": "執行分割",
        "split.done": "已分割為 {count} 個檔案，並加入未分組清單。",
        ...
        "split.files_added": "已新增 {count} 個分割檔案至未分組清單",
    ...
    "en": {
        ...
        "split.cancel": "Cancel",
        "split.execute": "Split",
        "split.done": "Split into {count} file(s) and added to ungrouped.",
        ...
        "split.files_added": "Added {count} split file(s) to ungrouped",
