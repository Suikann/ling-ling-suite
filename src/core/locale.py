...
_STRINGS: Dict[str, Dict[str, str]] = {
    "zh_TW": {
        ...
        "split.cancel": "取消",
        "split.execute": "執行分割",
        "split.done": "已分割為 {count} 個檔案，並建立群組。",
        ...
        "split.files_added": "已建立群組，包含 {count} 個檔案",
    ...
    "en": {
        ...
        "split.cancel": "Cancel",
        "split.execute": "Split",
        "split.done": "Split into {count} file(s) and created group.",
        ...
        "split.files_added": "Created group with {count} file(s)",
