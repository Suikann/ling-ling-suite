...
_STRINGS: Dict[str, Dict[str, str]] = {
    "zh_TW": {
        ...
        "catalog.settings.catalog_found": "已找到譜庫目錄：{name}",
        "catalog.settings.catalog_not_found": "此資料夾尚無譜庫目錄。",
        "catalog.settings.create_confirm": "此資料夾尚無譜庫目錄，要建立嗎？",
        "catalog.settings.catalog_created": "已在此資料夾建立譜庫目錄。",
    ...
    "en": {
        ...
        "catalog.settings.catalog_found": "Catalog found: {name}",
        "catalog.settings.catalog_not_found": "No catalog found in this folder.",
        "catalog.settings.create_confirm": "No catalog found in this folder. Create one?",
        "catalog.settings.catalog_created": "Catalog created in this folder.",
